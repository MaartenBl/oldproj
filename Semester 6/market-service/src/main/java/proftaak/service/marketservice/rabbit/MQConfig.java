...
public class MQConfig {
    ...
    public static final String KEY_CONSUMPTION = "energy.consumption.update";
    ...
    @Bean
    public Queue queueAnonymousConsumption(){
    ...
    @Bean
    public Binding bindingConsumption(TopicExchange topicExchange, @Qualifier("queueAnonymousConsumption") Queue queueAnonymousWeather){
        return BindingBuilder
                .bind(queueAnonymousWeather)
                .to(topicExchange)
                .with(KEY_CONSUMPTION); //listens to
    }
