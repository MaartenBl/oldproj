...
import CardMarketTabs from "../../components/Cards/Market/CardMarketTabs";
                        ...
                        <div className="rounded-t mb-0 px-6 py-6">
                            <div className="text-center mb-3">
                                <h6 className="text-gray-600 text-sm font-bold">
                                    Sign in with region credentials
                                </h6>
                            </div>
                                    ...
                                    <button
                                        ...
                                        onClick={ () => {
                                            ...
                                            if (user.password === '') {
                                                ...
                                                MarketAccount.mockLogin(user)
                                                    .then(response => {
                                                        setUser({...user, token: `Bearer ${response.data}`});
        ...
        <>
            <div className="flex flex-wrap mt-32">
                <div className="w-full">
                    {authorised ? <CardMarketTabs token={user.token}/> : MarketLogin()}
                </div>
            </div>
        </>
    );
