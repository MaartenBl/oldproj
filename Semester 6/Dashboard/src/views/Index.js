          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-gray-700">
                North - A data visualization platform for the Dutch energy market.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-gray-600">
                North is Free and Open Source.
                A distributed electricity (market) {" "}
                <a
                  href="https://github.com/S63-1/?ref=north"
                  className="text-gray-700"
                  target="_blank"
                >
                  simulation system{" "}
                </a>
                for the Netherlands northern regional energy grid utility companies. Taking into account the stakeholders'
                wishes as stated in the job description.
              </p>
              {/*<div className="mt-12">*/}
              {/*  <a*/}
