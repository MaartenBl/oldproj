...
const MarketBuyDropdown = (props) => {
    // dropdown props
    const [buy, setBuy] = React.useState({offerId: props.listing.id, amount: ''});
    ...
    const onAmountChange = (e) => {
        setBuy({...buy, amount: e.target.value});
...
export default MarketBuyDropdown;
